...
class IDU extends Module {
    ...
    val idu_signals: List[UInt] = ListLookup(
        inst,
        List(aluNop, 0.U, 0.U, 0.U, imm_NOP, 0.U, 0.U, 0.U, 0.U, 0.U),
        Array(
            instAdd_w    -> List(aluAdd   , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instAddi_w   -> List(aluAdd   , rjValue, imm_si12, rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instLd_w     -> List(aluAdd   , rjValue, imm_si12, rk, imm_NOP,  1.U,  1.U,  0.U, rd,       0.U),
            instSt_w     -> List(aluAdd   , rjValue, imm_si12, rd, imm_NOP,  0.U,  0.U,  1.U, rd,       0.U),
            instJirl     -> List(aluAdd   , pc     , imm_4,    rk, imm_NOP,  0.U,  1.U,  0.U, rd,       1.U),
            instBl       -> List(aluAdd   , pc     , imm_4,    rk, imm_si26, 0.U,  1.U,  0.U, 1.U(5.W), 1.U),
            instSub_w    -> List(aluSub   , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instSlt      -> List(aluSlt   , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instSltu     -> List(aluSltu  , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instNor      -> List(aluNor   , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instAnd      -> List(aluAnd   , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instOr       -> List(aluOr    , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instXor      -> List(aluXor   , rjValue, rkValue,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instSlli_w   -> List(aluSlliw , rjValue, imm_ui5,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instSrli_w   -> List(aluSrliw , rjValue, imm_ui5,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instSrai_w   -> List(aluSraiw , rjValue, imm_ui5,  rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instLu12i_w  -> List(aluLu12iw, rjValue, imm_si20, rk, imm_NOP,  0.U,  1.U,  0.U, rd,       0.U),
            instB        -> List(aluNop   , rjValue, rkValue,  rk, imm_si26, 0.U,  0.U,  0.U, rd,       1.U),
            instBeq      -> List(aluNop   , rjValue, rkValue,  rd, imm_si16, 0.U,  0.U,  0.U, rd,       2.U),
            instBne      -> List(aluNop   , rjValue, rkValue,  rd, imm_si16, 0.U,  0.U,  0.U, rd,       3.U)
        )
    )
    val aluOp :: aluSrc1 :: aluSrc2 :: raddr2 :: brOffs :: resFromMem :: grWe :: memWe :: dest :: jump :: Nil = idu_signals
